...
class CashRegister extends Model
{
    ...
    {
        $stmt = $this->db->prepare('SELECT * FROM cash_registers WHERE user_id=:uid AND status="aberto" ORDER BY id DESC LIMIT 1');
    ...
    {
        $stmt = $this->db->prepare('INSERT INTO cash_registers (user_id,opened_at,opening_amount,status,notes,created_at,updated_at) VALUES (:u,NOW(),:a,"aberto",:n,NOW(),NOW())');
