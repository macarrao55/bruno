...
<div class="card"><div class="card-body">
  ...
  <div class="table-responsive"><table class="table table-striped"><thead><tr><th>Produto</th><th>Categoria</th><th>Preço</th><th>Estoque</th><th>Mínimo</th><th>Código</th></tr></thead><tbody>
  <?php foreach ($produtos as $p): ?><tr><td><?= e($p['nome']) ?></td><td><?= e($p['categoria']) ?></td><td><?= money((float)$p['preco_venda']) ?></td><td><?= e((string)$p['estoque_atual']) ?></td><td><?= e((string)$p['estoque_minimo']) ?></td><td><?= e($p['codigo_barras']) ?></td></tr><?php endforeach; ?>
  </tbody></table></div>
</div></div>
<?php renderFooter(); ?>
