...
<form class="row g-2 mb-3" method="post" action="<?= BASE_URL ?>/actions/save_entrega.php">
  ...
  <div class="col-md-2"><select name="status" class="form-select"><option>preparando</option><option>em rota</option><option>entregue</option><option>cancelado</option><option>atrasado</option></select></div>
